...
// --- bærereglar c/c (cm), mellem de 5 reglar ---
lbl(400, 2560, "45", 64); lbl(755, 2560, "25", 64);
lbl(1127, 2560, "49", 64); lbl(1600, 2560, "45", 64);

lbl(hl/2, -560, "maal i cm fra hjorne (0,0)  ·  5 baerereglar, spaend <=49 cm", 64);
