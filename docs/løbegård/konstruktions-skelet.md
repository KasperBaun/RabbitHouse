...
**V5** højre (X=5905..6000, Y=1095..2905, 1810 mm langt).

Yarden har INGEN junction-stud mod V4 — V4's V1/V2-hjørnesidder hører til
...
z=120  └──────────────────────────────────────────────────────────────────────────────────┘
  ...
  E    = end-emit grid-stud (X=5955..6000 — ved V5-hjørnet)
...
**V5 i alt:** 4 full-height studs + 1 mid-rail.  
...
Rib ved X=2000 sidder lige op ad V4's yard-side og forstærker hus/yard-
overgangen.
...
| DPC murpap (V5)                  | 100×2   | 1800        | 1     | 1,8 m               |
| Bundrem PT (V1+V2 yard)          | 95×45   | 4000        | 2     | 8,0 m               |
| Bundrem PT (V5)                  | 95×45   | 1810        | 1     | 1,81 m              |
| Toprem perimeter (V1+V2 yard)    | 95×45   | 4000        | 2     | 8,0 m               |
| Toprem (V5)                      | 95×45   | 1810        | 1     | 1,81 m              |
| Toprem cross-rib                 | 95×45   | 1810        | 4     | 7,24 m              |
| Full-height stud (V1 7 + V2 8 + V5 4) | 45×95 | 2008      | 19    | 38,15 m             |
| Mid-rail (V1[L+R] + V2 + V5)     | 95×40   | (1465/4000/1810) | 4 | 8,74 m              |
...
| Reglar 45 × 95 × 2400 mm gran C24  | 4     | Cross-ribs + V5 toprem (1810 mm hver)                 |
| Reglar 45 × 95 × 4200 mm PT NTR-AB | 2     | Bundrem V1 + V2 yard (4000 mm)                        |
| Reglar 45 × 95 × 2400 mm PT NTR-AB | 1     | Bundrem V5 (1810 mm)                                  |
| Reglar 95 × 40 × 4200 mm gran      | 3     | Mid-rails — splejses op til 8,7 m total               |
| Bitumen-tape 100 mm × 10 m rulle   | 1     | Murpap — én rulle (9,8 m)                             |
| Ankerskruer M10 × 120              | 11    | Bundrem-til-sokkel c/c 1000 mm (4 V1 + 4 V2 + 3 V5)   |
| Vinkelbeslag 90×90 + skruer        | 8     | 2 hjørner (V1/V5 + V2/V5) × 4 stk                     |
...
1. **DPC** — læg bitumen-tape 100 mm bred ovenpå sokkel-ringen på alle
   yard-vægge (V1+V2 yard-segment + V5).

2. **Bundrem** — bor M10-huller c/c 1000 mm, læg bundrem på plads og
   spænd ankerskruerne. Bundremmen butter mod V4's bundrem ved X=2000.

3. **V5 (højre)** først — 4 studs c/c 600 + end-emit. Top-plade ovenpå.
...
7. **Mid-rail på V5** — fastgør 1810 mm mid-rail i z=1177..1217 indvendigt
   mellem V1 og V2.

8. **Vinkelbeslag** — fastgør V5 mod V1+V2 og spænd alle samlinger.
...
- Stud-længde 2008 mm ens på V1[yard], V2[yard], V5
